...
const pushTemplates: Record<string, Record<Locale, { title: string; body: string }>> = {
  package_received: {
    en: { title: '\ud83d\udce6 Package Received!', body: 'Great news! Your package {{tracking}} ({{weight}} lbs) has arrived safely at our Miami warehouse. Destination: {{city}}.\n\ud83d\udcb0 Estimated total: ${{total}}\nWe\'ll notify you at every step. Thank you for trusting Alliance Shipping!' },
    fr: { title: '\ud83d\udce6 Colis Re\u00e7u !', body: 'Bonne nouvelle ! Votre colis {{tracking}} ({{weight}} lbs) est bien arriv\u00e9 \u00e0 notre entrep\u00f4t de Miami. Destination : {{city}}.\n\ud83d\udcb0 Total estim\u00e9 : ${{total}}\nNous vous tiendrons inform\u00e9 \u00e0 chaque \u00e9tape. Merci de faire confiance \u00e0 Alliance Shipping !' },
    ht: { title: '\ud83d\udce6 Kolis Resevwa !', body: 'Bon nouvèl ! Kolis ou {{tracking}} ({{weight}} lbs) rive nan depo Miami nou an. Destinasyon : {{city}}.\n\ud83d\udcb0 Total estime : ${{total}}\nN ap kenbe ou enfòme chak etap. Mèsi paske ou fè konfyans ak Alliance Shipping !' },
    es: { title: '\ud83d\udce6 \u00a1Paquete Recibido!', body: '\u00a1Buenas noticias! Su paquete {{tracking}} ({{weight}} lbs) lleg\u00f3 a nuestro almac\u00e9n en Miami. Destino: {{city}}.\n\ud83d\udcb0 Total estimado: ${{total}}\nLe notificaremos en cada paso. \u00a1Gracias por confiar en Alliance Shipping!' },
  },
  package_in_transit: {
